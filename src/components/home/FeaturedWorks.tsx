    ...
    >
      <div className="section-container relative z-10">
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-5"
        >
          <div>
          ...
          {displayData.map((project, i) => {
            ...
            return (
              ...
              >
                <Link
                  href={`/works/${slug}`}
                  className="group flex flex-col md:flex-row md:items-center justify-between py-12 sm:py-14 gap-8 border-t border-[var(--color-border)]/50 transition-all duration-500 hover:px-5"
                >
