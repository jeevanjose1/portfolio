    ...
    <section className="bg-white py-16 border-t border-gray-50">
      <div className="section-container">
        <div className="mb-16">
           ...
           <h2 className="text-4xl font-heading font-black text-primary">Common Inquiries.</h2>
        </div>
        <motion.div
        ...
        >
          {[{ q: "International clients?", a: "Yes, I work with clients worldwide via Upwork, Contra, and direct engagement. Time zones are not an issue." },
            ...
            <div key={item.q} className="bg-section-alt p-10 rounded-lg border border-gray-100 hover:border-accent/20 transition-colors group">
              <div className="w-10 h-10 rounded-full bg-white border border-gray-100 flex items-center justify-center mb-6 group-hover:bg-accent group-hover:text-white transition-colors">
                 <HelpCircle size={18} className="text-accent group-hover:text-white transition-colors" />
              </div>
              <h3 className="font-heading font-black text-primary mb-4 text-xl tracking-tight">{item.q}</h3>
