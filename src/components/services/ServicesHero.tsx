        ...
        >
          ...
          <div className="md:col-span-4 flex flex-col gap-4">
            ...
            <motion.div
              custom={2}
              variants={fadeUp}
              className="bg-primary rounded-lg p-6 flex flex-col justify-center border border-border text-background"
            >
              ...
              <p className="text-background/60 text-sm mt-1">From architecture to deployment</p>
            </motion.div>
          </div>
        </motion.div>
      </div>
