          ...
          {otherServices.map((service, i) => {
            ...
            return (
              <Reveal
                ...
                className="h-full"
              >
                <GradientCard className="h-full border border-[var(--color-card-border)] p-8 sm:p-10 flex flex-col bg-background transition-all duration-500 hover:border-[color-mix(in_srgb,var(--color-accent)_25%,transparent)] hover:-translate-y-0.5 group" >
