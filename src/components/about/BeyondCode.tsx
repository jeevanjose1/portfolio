...
function BeyondCard({ item, index }: { item: BeyondCodeItem; index: number }) {
  ...
  return (
    ...
    >
      <div
        className="bg-background rounded-2xl p-10 border border-[var(--color-card-border)] hover:border-[color-mix(in_srgb,var(--color-accent)_30%,transparent)] hover:-translate-y-0.5 transition-all duration-500 group relative overflow-hidden h-full flex flex-col"
      >
